// Code generated by go generate at 2021-05-13T13:03:38+08:00; DO NOT EDIT.
...
func (x Int8sAsc) Len() int           { return len(x) }
func (x Int8sAsc) Less(i, j int) bool { return x[i] < x[j] }
func (x Int8sAsc) Swap(i, j int)      { x[i], x[j] = x[j], x[i] }

// Sort is a convenience method which calls sort.Sort(x).
func (x Int8sAsc) Sort() { sort.Sort(x) }

// Int8sDesc attaches the methods of sort.Interface to []int8, sorting in descending order.
type Int8sDesc []int8

func (x Int8sDesc) Len() int           { return len(x) }
func (x Int8sDesc) Less(i, j int) bool { return x[i] > x[j] }
func (x Int8sDesc) Swap(i, j int)      { x[i], x[j] = x[j], x[i] }

// Sort is a convenience method which calls sort.Sort(x).
func (x Int8sDesc) Sort() { sort.Sort(x) }

// SortInt8sAsc is a convenience method which calls sort.Sort(Int8sAsc(x)).
func SortInt8sAsc(x []int8) { sort.Sort(Int8sAsc(x)) }

// SortInt8sDesc is a convenience method which calls sort.Sort(Int8sDesc(x)).
func SortInt8sDesc(x []int8) { sort.Sort(Int8sDesc(x)) }

// Int8sAreSortedAsc is a convenience method which calls sort.IsSorted(Int8sAsc(x)).
func Int8sAreSortedAsc(x []int8) bool { return sort.IsSorted(Int8sAsc(x)) }

// Int8sAreSortedDesc is a convenience method which calls sort.IsSorted(Int8sDesc(x)).
func Int8sAreSortedDesc(x []int8) bool { return sort.IsSorted(Int8sDesc(x)) }

// InSortedInt8s tells whether elem is in a sorted int8 slice.
...
func (x Uint8sAsc) Len() int           { return len(x) }
func (x Uint8sAsc) Less(i, j int) bool { return x[i] < x[j] }
func (x Uint8sAsc) Swap(i, j int)      { x[i], x[j] = x[j], x[i] }

// Sort is a convenience method which calls sort.Sort(x).
func (x Uint8sAsc) Sort() { sort.Sort(x) }

// Uint8sDesc attaches the methods of sort.Interface to []uint8, sorting in descending order.
type Uint8sDesc []uint8

func (x Uint8sDesc) Len() int           { return len(x) }
func (x Uint8sDesc) Less(i, j int) bool { return x[i] > x[j] }
func (x Uint8sDesc) Swap(i, j int)      { x[i], x[j] = x[j], x[i] }

// Sort is a convenience method which calls sort.Sort(x).
func (x Uint8sDesc) Sort() { sort.Sort(x) }

// SortUint8sAsc is a convenience method which calls sort.Sort(Uint8sAsc(x)).
func SortUint8sAsc(x []uint8) { sort.Sort(Uint8sAsc(x)) }

// SortUint8sDesc is a convenience method which calls sort.Sort(Uint8sDesc(x)).
func SortUint8sDesc(x []uint8) { sort.Sort(Uint8sDesc(x)) }

// Uint8sAreSortedAsc is a convenience method which calls sort.IsSorted(Uint8sAsc(x)).
func Uint8sAreSortedAsc(x []uint8) bool { return sort.IsSorted(Uint8sAsc(x)) }

// Uint8sAreSortedDesc is a convenience method which calls sort.IsSorted(Uint8sDesc(x)).
func Uint8sAreSortedDesc(x []uint8) bool { return sort.IsSorted(Uint8sDesc(x)) }

// InSortedUint8s tells whether elem is in a sorted uint8 slice.
// The given slice must be sorted in either ascending order or
// descending, else it may give incorrect result.
...
func (x Int16sAsc) Len() int           { return len(x) }
func (x Int16sAsc) Less(i, j int) bool { return x[i] < x[j] }
func (x Int16sAsc) Swap(i, j int)      { x[i], x[j] = x[j], x[i] }

// Sort is a convenience method which calls sort.Sort(x).
func (x Int16sAsc) Sort() { sort.Sort(x) }

// Int16sDesc attaches the methods of sort.Interface to []int16, sorting in descending order.
type Int16sDesc []int16

func (x Int16sDesc) Len() int           { return len(x) }
func (x Int16sDesc) Less(i, j int) bool { return x[i] > x[j] }
func (x Int16sDesc) Swap(i, j int)      { x[i], x[j] = x[j], x[i] }

// Sort is a convenience method which calls sort.Sort(x).
func (x Int16sDesc) Sort() { sort.Sort(x) }

// SortInt16sAsc is a convenience method which calls sort.Sort(Int16sAsc(x)).
func SortInt16sAsc(x []int16) { sort.Sort(Int16sAsc(x)) }

// SortInt16sDesc is a convenience method which calls sort.Sort(Int16sDesc(x)).
func SortInt16sDesc(x []int16) { sort.Sort(Int16sDesc(x)) }

// Int16sAreSortedAsc is a convenience method which calls sort.IsSorted(Int16sAsc(x)).
func Int16sAreSortedAsc(x []int16) bool { return sort.IsSorted(Int16sAsc(x)) }

// Int16sAreSortedDesc is a convenience method which calls sort.IsSorted(Int16sDesc(x)).
func Int16sAreSortedDesc(x []int16) bool { return sort.IsSorted(Int16sDesc(x)) }

// InSortedInt16s tells whether elem is in a sorted int16 slice.
// The given slice must be sorted in either ascending order or
// descending, else it may give incorrect result.
...
func (x Uint16sAsc) Len() int           { return len(x) }
func (x Uint16sAsc) Less(i, j int) bool { return x[i] < x[j] }
func (x Uint16sAsc) Swap(i, j int)      { x[i], x[j] = x[j], x[i] }

// Sort is a convenience method which calls sort.Sort(x).
func (x Uint16sAsc) Sort() { sort.Sort(x) }

// Uint16sDesc attaches the methods of sort.Interface to []uint16, sorting in descending order.
type Uint16sDesc []uint16

func (x Uint16sDesc) Len() int           { return len(x) }
func (x Uint16sDesc) Less(i, j int) bool { return x[i] > x[j] }
func (x Uint16sDesc) Swap(i, j int)      { x[i], x[j] = x[j], x[i] }

// Sort is a convenience method which calls sort.Sort(x).
func (x Uint16sDesc) Sort() { sort.Sort(x) }

// SortUint16sAsc is a convenience method which calls sort.Sort(Uint16sAsc(x)).
func SortUint16sAsc(x []uint16) { sort.Sort(Uint16sAsc(x)) }

// SortUint16sDesc is a convenience method which calls sort.Sort(Uint16sDesc(x)).
func SortUint16sDesc(x []uint16) { sort.Sort(Uint16sDesc(x)) }

// Uint16sAreSortedAsc is a convenience method which calls sort.IsSorted(Uint16sAsc(x)).
func Uint16sAreSortedAsc(x []uint16) bool { return sort.IsSorted(Uint16sAsc(x)) }

// Uint16sAreSortedDesc is a convenience method which calls sort.IsSorted(Uint16sDesc(x)).
func Uint16sAreSortedDesc(x []uint16) bool { return sort.IsSorted(Uint16sDesc(x)) }

// InSortedUint16s tells whether elem is in a sorted uint16 slice.
// The given slice must be sorted in either ascending order or
// descending, else it may give incorrect result.
...
func (x UintptrsAsc) Len() int           { return len(x) }
func (x UintptrsAsc) Less(i, j int) bool { return x[i] < x[j] }
func (x UintptrsAsc) Swap(i, j int)      { x[i], x[j] = x[j], x[i] }

// Sort is a convenience method which calls sort.Sort(x).
func (x UintptrsAsc) Sort() { sort.Sort(x) }

// UintptrsDesc attaches the methods of sort.Interface to []uintptr, sorting in descending order.
type UintptrsDesc []uintptr

func (x UintptrsDesc) Len() int           { return len(x) }
func (x UintptrsDesc) Less(i, j int) bool { return x[i] > x[j] }
func (x UintptrsDesc) Swap(i, j int)      { x[i], x[j] = x[j], x[i] }

// Sort is a convenience method which calls sort.Sort(x).
func (x UintptrsDesc) Sort() { sort.Sort(x) }

// SortUintptrsAsc is a convenience method which calls sort.Sort(UintptrsAsc(x)).
func SortUintptrsAsc(x []uintptr) { sort.Sort(UintptrsAsc(x)) }

// SortUintptrsDesc is a convenience method which calls sort.Sort(UintptrsDesc(x)).
func SortUintptrsDesc(x []uintptr) { sort.Sort(UintptrsDesc(x)) }

// UintptrsAreSortedAsc is a convenience method which calls sort.IsSorted(UintptrsAsc(x)).
func UintptrsAreSortedAsc(x []uintptr) bool { return sort.IsSorted(UintptrsAsc(x)) }

// UintptrsAreSortedDesc is a convenience method which calls sort.IsSorted(UintptrsDesc(x)).
func UintptrsAreSortedDesc(x []uintptr) bool { return sort.IsSorted(UintptrsDesc(x)) }

// InSortedUintptrs tells whether elem is in a sorted uintptr slice.
// The given slice must be sorted in either ascending order or
// descending, else it may give incorrect result.
