...
// user can call Free to release the allocated memory together.
// It's efficient for memory-heavy workloads.
type Arena struct {
	chunkSize int
...
// NewOffHeapArena creates a OffHeapArena which allocates memory directly
...
// Free frees all memory chunks managed by the arena.
func (a *Arena) Free() {
